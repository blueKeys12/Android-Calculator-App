...
public:
	...
	*/
	 ...
	 int countPosition(int index) const; // *
	...
	bool update(char val, int amount); //*
...
private:
	...
	void remove(Node * curr, Node * trail){
		if (curr == head) head = head->next;
		else trail->next = curr->next;

		delete curr;
	}//Remove function to cut down on copied code.
};
#endif 